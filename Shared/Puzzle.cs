...
namespace PuzzlePortal.Shared
{
    public class Puzzle
    {
        ...
        // TODO:
        private static readonly Puzzle Skewers = new Puzzle { Name = nameof(Skewers), Id = new Guid("8cfcdc16-fc45-472b-8a9f-a10b995e4248") };
        private static readonly Puzzle CuminsLore = new Puzzle { Name = nameof(CuminsLore), Id = new Guid("fc4acc00-04c0-4fb5-8ea8-129dbe24ca1f") };
